...
class ManageAccessActivity : AppCompatActivity() {
    ...
    private fun showGrantDialog() {
        ...
        spinnerDur.adapter = ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, durations)
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Grant") { _, _ ->
                ...
                if (email.isEmpty()) { Toast.makeText(this, "Enter an email!", Toast.LENGTH_SHORT).show(); return@setPositiveButton }
    ...
    private fun grantByEmail(email: String, expiresAt: Long?) {
        ...
        userRepository.findUserByEmail(email) { user ->
            ...
            permissionRepository.grantAccess(
                ...
                grantedByUid = myUid,
                onSuccess    = {
                    Toast.makeText(this, "Access granted to ${user.displayName}", Toast.LENGTH_SHORT).show()
